...
INSERT INTO tbl_customers (id, number_id,first_name,last_name , email, photo_url, region_id, state, created_date,created_user,row_version) VALUES(1,32303270, 'Andrés', 'Guzmán', 'profesor@bolsadeideas.com','',1,'CREATED',CURRENT_TIMESTAMP,'admin',0);
